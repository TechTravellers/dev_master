					  ...
					  <div class="wthree_general graph-form agile_info_shadow ">
						 <h3 class="w3_inner_tittle two">Add State/Province Details </h3>
							<?php 
								...
								$sql = "select * from state where state_id='$state_id' limit 1";
									...
									<div class="form-body">
											<form class="form-horizontal">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" class="form-control1" id="state_code" name="state_code" placeholder="Eg: 033" value="<?php echo $row["state_code"];?>" required />
														<input type="hidden" class="form-control1" id="state_id" name="state_id" placeholder="Eg: 033" value="<?php echo $row["state_id"];?>" required />
													</div>
													<!--<div class="col-sm-2">
														<p class="help-block">Your help text!</p>
													</div>-->
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" class="form-control1" id="state_name" name="state_name" placeholder="Eg: India" value="<?php echo $row["state_name"];?>" required />
													</div>
													<!--<div class="col-sm-2">
														<p class="help-block">Your help text!</p>
													</div>-->
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<textarea name="txtarea1" id="state_details" name="state_details" cols="50" rows="6" placeholder="Eg: West Bengal is one of the most beautiful state in India." class="form-control1"><?php echo $row["state_details"];?></textarea>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" class="form-control1" id="language" name="language" placeholder="Eg: Bengali" value="<?php echo $row["language"];?>" required />
													</div>
													<!--<div class="col-sm-2">
														<p class="help-block">Your help text!</p>
													</div>-->
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" class="form-control1" id="no_of_people" name="no_of_people" placeholder="Eg: 1.2 Million" value="<?php echo $row["no_of_people"];?>" required />
													</div>
													<!--<div class="col-sm-2">
														<p class="help-block">Your help text!</p>
													</div>-->
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" class="form-control1" id="no_of_cities" name="no_of_cities" placeholder="Eg: 28" value="<?php echo $row["no_of_cities"];?>" required />
													</div>
													<!--<div class="col-sm-2">
														<p class="help-block">Your help text!</p>
													</div>-->
...
<script type="text/javascript">
	...
	$('#add').click(function (e) {
		...
		if(country_id == ""){
			...
			$.ajax({
				url: "query/updateState.php",
				type: "post",
				data: "state_id="+state_id+"&country_id="+country_id+"&state_code="+state_code+"&state_name="+state_name+"&state_details="+state_details+"&language="+language+"&no_of_people="+no_of_people+"&no_of_cities="+no_of_cities,
				success: function (response) {
					//alert(response);
					if(response == 1){
						 alertify.alert(
							'TechTraveller', 'State Updated!', 
							function(){
								window.location = "viewStates.php";
