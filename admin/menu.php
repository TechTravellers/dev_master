<div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									<a href="#"><i class="fa fa-cogs" aria-hidden="true"></i> CMS <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="viewBlog.php"><i class="fa fa-caret-right" aria-hidden="true"></i> Blog</a></li>
										<!--<li class="mini_list_w3"><a href="grids.html"> <i class="fa fa-caret-right" aria-hidden="true"></i> Grids</a></li>-->
									</ul>
								</li>
								<li>
									<a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>DMS <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="viewCountries.php"><i class="fa fa-caret-right" aria-hidden="true"></i> Countries</a></li>
										<li class="mini_list_agile"><a href="viewStates.php"><i class="fa fa-caret-right" aria-hidden="true"></i> States/Provinces</a></li>
										<li class="mini_list_agile"><a href="viewDistricts.php"><i class="fa fa-caret-right" aria-hidden="true"></i> Districts</a></li>
										
									</ul>
								</li>
                                                                <li>
									<a href="#"> <i class="fa fa-circle-o" aria-hidden="true"></i>Contest <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="viewContestImages.php"><i class="fa fa-file-image-o" aria-hidden="true"></i> Images</a></li>
				...
				<!-- //nav_agile_w3l -->
				<li class="second logo"><h1><a href="dashboard.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i>TechTraveller </a></h1></li>
