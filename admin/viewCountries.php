									...
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two"><a href="addCountry.php" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> New</a></h3>
											...
											<tbody>
											 <?php 
												$sql = "select * from country order by date desc";
											...
											?>
												<tr>
													...
													<td><?php echo $row['country_details'];?></td>
													<td><?php echo $row['language'];?></td>
													<td><?php echo $row['no_of_people'];?></td>
													<td><?php echo $row['no_of_province'];?></td>
													<td><a href="editCountry.php?country_id=<?php echo $row['country_id'];?>"><i class="fa fa-pencil fa-2x"  aria-hidden="true"></i><a></td>
