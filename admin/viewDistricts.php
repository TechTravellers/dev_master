		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Districts</h2>
									<!-- tables -->
									
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two"><a href="addDistrict.php" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> New</a></h3>
											<table id="table">
											<thead>
											  <tr>
												<th>ID</th>
											...
											<tbody>
											 <?php 
												$sql = "select * from district order by date desc";
											...
											?>
												<tr>
													...
													<td><?php echo $row['district_details'];?></td>
													<td><?php echo $row['headquarter'];?></td>
													<td><?php echo $row['populations'];?></td>
													<td><a href="editDistrict.php?district_id=<?php echo $row['district_id'];?>"><i class="fa fa-pencil fa-2x"  aria-hidden="true"></i><a></td>
